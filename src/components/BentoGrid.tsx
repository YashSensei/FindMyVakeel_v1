...
const bentoItems: BentoItem[] = [
    {
        ...
        description:
            "We connect startups with experienced legal professionals who understand your unique challenges and regulatory requirements.",
        href: "/products",
        feature: "spotlight",
        spotlightItems: [
            "Multilingual AI intake system",
    ...
    },
    {
        ...
        description:
            "Intelligent matching system that connects you with the right legal expert based on your specific needs",
        href: "/products",
        feature: "typing",
        typingText:
            "const findLawyer = async (query) => {\n  const match = await ai.analyze({\n    userNeeds: query,\n    specialization: 'startup-law',\n    language: 'multilingual',\n    availability: 'real-time'\n  });\n\n  return match.bestFit;\n};",
        size: "md",
    ...
    },
    {
        ...
        description:
            "Leveraging the latest AI technology to provide accurate, efficient legal assistance",
        icons: true,
        href: "/about",
        feature: "icons",
        size: "md",
    ...
    },
    {
        ...
        title: "Our journey",
        description:
            "Building the future of accessible legal services for everyone in India",
        href: "/about",
        feature: "timeline",
        timeline: [
            { year: "2024", event: "Launch of Find My Vakeel Platform" },
            { year: "2024", event: "Multilingual AI Integration" },
            { year: "2024", event: "Smart Matching System Launch" },
            { year: "2025", event: "Real-time Dashboard Implementation" },
            { year: "2025", event: "Expanding to 10+ Languages" },
        ],
        size: "sm",
        className: "col-span-1 row-span-1",
    },
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-100/80 to-neutral-100 dark:from-neutral-800/80 dark:to-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 group transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Brain className="w-7 h-7 text-[#8B5CF6] transition-transform" />
                </div>
            ...
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-100/80 to-neutral-100 dark:from-neutral-800/80 dark:to-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 group transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Cpu className="w-7 h-7 text-[#3B82F6] transition-transform" />
                </div>
                <span className="text-xs font-medium text-center text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-900 dark:group-hover:text-neutral-200">
                    Processing
                </span>
            ...
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-100/80 to-neutral-100 dark:from-neutral-800/80 dark:to-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 group transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Network className="w-7 h-7 text-[#10B981] transition-transform" />
                </div>
                <span className="text-xs font-medium text-center text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-900 dark:group-hover:text-neutral-200">
                    Integration
                </span>
            ...
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-100/80 to-neutral-100 dark:from-neutral-800/80 dark:to-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 group transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Sparkles className="w-7 h-7 text-[#F59E0B] transition-transform" />
                </div>
                <span className="text-xs font-medium text-center text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-900 dark:group-hover:text-neutral-200">
                    Innovation
                </span>
            ...
            <motion.div className="flex flex-col items-center gap-2 p-3 rounded-xl bg-gradient-to-b from-neutral-100/80 to-neutral-100 dark:from-neutral-800/80 dark:to-neutral-800 border border-neutral-200/50 dark:border-neutral-700/50 group transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-600">
                <div className="relative w-8 h-8 flex items-center justify-center">
                    <Zap className="w-7 h-7 text-[#EF4444] transition-transform" />
                </div>
                <span className="text-xs font-medium text-center text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-900 dark:group-hover:text-neutral-200">
                    Performance
                </span>
                    ...
                    <div className="space-y-2 flex-1 flex flex-col">
                        ...
                        {item.icons && !item.feature && (
                            <div className="mt-auto pt-4 flex items-center flex-wrap gap-4 border-t border-neutral-200/70 dark:border-neutral-800/70">
                                <Brain className="w-5 h-5 text-[#8B5CF6] opacity-70 hover:opacity-100 transition-opacity" />
                                <Cpu className="w-5 h-5 text-[#3B82F6] opacity-70 hover:opacity-100 transition-opacity" />
                                <Network className="w-5 h-5 text-[#10B981] opacity-70 hover:opacity-100 transition-opacity" />
                                <Sparkles className="w-5 h-5 text-[#F59E0B] opacity-70 hover:opacity-100 transition-opacity" />
                                <Zap className="w-5 h-5 text-[#EF4444] opacity-70 hover:opacity-100 transition-opacity" />
                            </div>
                        )}
                    </div>
                </div>
...
export default function BentoGrid() {
    return (
        <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 bg-white dark:bg-black overflow-hidden">
